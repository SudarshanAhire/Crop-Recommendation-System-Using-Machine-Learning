...
def predict():
    ...
    print(f"Inputs: N={N}, P={P}, K={K}, Temperature={temp}, Humidity={humidity}, pH={ph}, Rainfall={rainfall}")

    # Creating feature array and reshaping it for the model
    feature_list = [N, P, K, temp, humidity, ph, rainfall]
    single_pred = np.array(feature_list).reshape(1, -1)

    # Debugging: Print before scaling
    print("Before scaling:", single_pred)
    ...
    print("After scaling:", final_features)
